    ...
    <div class="container">
        ...
        <form action="scheduler.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <!-- Replace this with the dynamic professor dropdown -->
                <select class="form-select" name="professor" id="professor">
                    ...
                    // Query to fetch professors from the database
                    $professor_query = "SELECT salutation, firstname, lastname FROM professors";
                    $result = $conn->query($professor_query);

                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            // Combine salutation, firstname, and lastname to display in dropdown
                            $professor_name = $row["salutation"] . " " . $row["firstname"] . " " . $row["lastname"];
